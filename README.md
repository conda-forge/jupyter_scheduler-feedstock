...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter_scheduler-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter_scheduler-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter-scheduler jupyter_scheduler
# for installing globally
pixi global install jupyter-scheduler jupyter_scheduler
```
...
It is possible to list all of the versions of `jupyter-scheduler` available on your platform:
...
```
pixi search jupyter-scheduler --channel conda-forge
```
